...
const ProfessionalRating = () => {
  const { expanded, toggleExpand, productViewData, productDetailLoading } = UseProductView();
        ...
        {expanded && (
          <RatingsGrid container spacing={2}>
            {productDetailLoading
              ...
              : productViewData?.professionalRating?.length
                ...
                : !productDetailLoading && <p>No professional ratings available.</p>}
          </RatingsGrid>
        )}
      </Container>
    </ProductLayoutContainer>
