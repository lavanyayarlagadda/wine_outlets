...
export const productViewData: ProductViewResponse = {
  product: {
    ...
    cartQunatity: 0,
    description:
      "The 2018 vintage represents the primacy of Barcloux winemaking excellence. Château Margaux has crafted a wine for extraordinary complexity and retirement, showcasing the unique sense of the Margaux application.",
    highlights:
      "Italy – Bright and inviting with a pale straw hue. The aroma features fresh rice fruits, especially ripe pear. Light-colored and refreshing crisp, this Prick grigio clatteries vibrant fruit leaves and truly exactly. An easy-defining wine brute perfect for berries, casual girl-bogprints, and sunny afternoons.",
    details: {
    ...
    foodPairings:
      "Pain beautifully with grilled steak, turtle frosted, and braised lamb. Also recommended as an example of food pairings that are not made by any other manufacturer or manufacturer.",
    in_stock: true,
    images: [
  ...
  professionalRating: [
    {
      ...
      score: 40,
      description:
        "Beautiful, ripe redcurrants, bay leaf, violets and raspberries on the nose. Full-bodied with firm and very tight tannins",
    },
    {
      title: "James Suckling",
      score: 90,
